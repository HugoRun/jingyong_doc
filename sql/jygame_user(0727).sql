...
CREATE TABLE `exception_user_log` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=361 DEFAULT CHARSET=gbk;
...
CREATE TABLE `game_statistics` (
  ...
  PRIMARY KEY  (`gs_id`)
) ENGINE=InnoDB AUTO_INCREMENT=172854 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=4082270 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=193 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_log_exp` (
  ...
  `createtime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4420 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2762524 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2264504 DEFAULT CHARSET=gbk;
...
CREATE TABLE `user_online_time` (
  ...
  `createTime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=156263 DEFAULT CHARSET=gbk;
