...
CREATE TABLE `exception_user_log` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=10656 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_log_money` (
  ...
  `createtime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2124 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_log_player` (
  ...
  `createtime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1861 DEFAULT CHARSET=gbk;
