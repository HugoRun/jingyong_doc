...
CREATE TABLE `game_statistics` (
  ...
  PRIMARY KEY  (`gs_id`)
) ENGINE=InnoDB AUTO_INCREMENT=172959 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=66104 DEFAULT CHARSET=gbk;
...
CREATE TABLE `s_setting_info` (
  ...
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=66013 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=4082537 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=85032 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2762589 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_mounts_temp` (
  ...
  `hightLevel` int(11) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=260 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=435 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_part_info` (
  ...
  KEY `Index2` (`u_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=66025 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=85022 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_prelude` (
  ...
  PRIMARY KEY  (`pr_id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=62601 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2265451 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_shortcut_info` (
  ...
  PRIMARY KEY  (`sc_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=594109 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_special_item` (
  ...
  PRIMARY KEY  (`sp_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=83446 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_title` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=69041 DEFAULT CHARSET=gbk;
...
CREATE TABLE `user_online_time` (
  ...
  `createTime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=156290 DEFAULT CHARSET=gbk;
...
CREATE TABLE `user_record_login` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=62605 DEFAULT CHARSET=gbk;
