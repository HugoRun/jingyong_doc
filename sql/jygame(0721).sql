...
CREATE TABLE `commodity_info` (
  ...
  `buy_mode` int(11) default NULL,
  `original_price` int(11) default NULL,
  `discount` int(11) default '-1',
  `commodity_total` int(11) default '-1',
  `sell_num` int(11) default '0',
  `is_hot` int(11) default '0',
  `state` int(11) default '1',
  `isUsedAfterBuy` int(11) default '0',
  `hot_display` varchar(300) default NULL,
  `create_time` datetime default NULL,
  `is_nomral` int(11) default '0',
  `is_hotmall` int(11) default '0',
  `is_jfmall` int(11) default '0',
  `is_vipmall` int(11) default '0',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=975 DEFAULT CHARSET=gbk;
...
CREATE TABLE `honour` (
  ...
  `ho_title` varchar(100) default NULL,
  `ho_type` int(11) default NULL,
  `ho_type_name` varchar(100) default NULL,
  `ho_display` varchar(100) default NULL,
  `ho_attack` int(11) default '0',
  `ho_def` int(11) default '0',
  `ho_hp` int(11) default '0',
  `ho_crit` int(11) default '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=11887 DEFAULT CHARSET=gbk;
...
CREATE TABLE `operate_menu_info` (
  ...
  KEY `Index2` (`menu_father_id`,`menu_order`)
...
CREATE TABLE `prop` (
  ...
  `prop_display` varchar(200) default NULL,
...
CREATE TABLE `suit_info` (
  ...
  `suit_parts` varchar(100) default NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=1803 DEFAULT CHARSET=gbk;
...
CREATE TABLE `title_info` (
  `title_id` varchar(100) NOT NULL default '',
  `title_name` varchar(100) default NULL,
  `school_id` varchar(100) default NULL,
  `school_name` varchar(100) default NULL,
  `title_level_down` int(11) default NULL,
  `title_level_up` int(11) default NULL,
...
CREATE TABLE `u_grow_info` (
  ...
  `g_grade` int(11) default NULL,
  `g_school` varchar(500) default NULL,
  `g_title` varchar(500) default NULL,
  `g_exp` varchar(500) default NULL,
  `g_next_exp` varchar(500) default NULL,
  `g_HP` int(11) default NULL,
  `g_MP` int(11) default NULL,
  `g_gj` int(11) default NULL,
  `g_fy` int(11) default NULL,
  `g_isAutogrow` int(11) default NULL COMMENT '0表示需要专职道具',
  `g_drop_multiple` double default NULL,
  PRIMARY KEY  (`g_pk`)
) ENGINE=MyISAM AUTO_INCREMENT=223 DEFAULT CHARSET=gbk;
...
CREATE TABLE `vip` (
  ...
  `mall_agio` int(11) default NULL,
  `ho_id` int(11) default NULL,
  `is_die_drop_exp` int(11) default '0',
  `v_hint` varchar(600) default NULL,
  `v_money` int(11) default '0',
  PRIMARY KEY  (`v_id`)
