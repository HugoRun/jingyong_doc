...
CREATE TABLE `auto` (
  ...
  KEY `id` (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=3385 DEFAULT CHARSET=gbk;
...
CREATE TABLE `exception_user_log` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=298 DEFAULT CHARSET=gbk;
...
CREATE TABLE `game_prize` (
  ...
  `create_time` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=514 DEFAULT CHARSET=gbk;
...
CREATE TABLE `game_prize_info` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3551 DEFAULT CHARSET=gbk;
...
CREATE TABLE `game_sellinfo_record` (
  ...
  PRIMARY KEY  (`s_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=13601 DEFAULT CHARSET=gbk;
...
CREATE TABLE `game_statistics` (
  ...
  PRIMARY KEY  (`gs_id`)
) ENGINE=InnoDB AUTO_INCREMENT=172785 DEFAULT CHARSET=gbk;
...
/*Table structure for table `n_dropexpmoney_info` */

DROP TABLE IF EXISTS `n_dropexpmoney_info`;

CREATE TABLE `n_dropexpmoney_info` (
  `d_pk` int(11) NOT NULL auto_increment,
  `p_pk` int(11) default NULL,
  `drop_exp` int(11) default NULL,
  `drop_money` int(11) default NULL,
  `drop_pet_exp` int(11) default NULL,
  PRIMARY KEY  (`d_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=4224426 DEFAULT CHARSET=gbk;

/*Table structure for table `n_dropgoods_info` */

DROP TABLE IF EXISTS `n_dropgoods_info`;
...
CREATE TABLE `n_dropgoods_info` (
  ...
  `goods_importance` int(11) default '0',
  `goods_dropInfo` varchar(100) default NULL,
  PRIMARY KEY  (`d_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=4797 DEFAULT CHARSET=gbk;
...
CREATE TABLE `n_dropgoods_pk` (
  ...
  PRIMARY KEY  (`dp_pk`),
  KEY `Index1` (`a_p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=5157 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=47676 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=189103 DEFAULT CHARSET=gbk;
...
CREATE TABLE `pk_dropgoods_notify` (
  ...
  `goods_quality` int(11) default '0',
  PRIMARY KEY  (`pn_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=5194 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=66088 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=1513 DEFAULT CHARSET=gbk;
...
CREATE TABLE `s_setting_info` (
  ...
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=65997 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=4082136 DEFAULT CHARSET=gbk;
...
/*Table structure for table `t_role_honour` */

DROP TABLE IF EXISTS `t_role_honour`;

CREATE TABLE `t_role_honour` (
  `ro_id` int(11) NOT NULL auto_increment,
  `p_pk` int(11) default NULL,
  `ho_id` int(11) default NULL,
  `ho_type` int(11) default NULL,
  `is_reveal` int(11) default '0',
  `detail` varchar(255) default NULL,
  `create_time` datetime default NULL,
  PRIMARY KEY  (`ro_id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=69011 DEFAULT CHARSET=gbk;

/*Table structure for table `t_role_vip` */

DROP TABLE IF EXISTS `t_role_vip`;
...
CREATE TABLE `t_role_vip` (
  ...
  `rv_begin_time` datetime default NULL,
  `rv_end_time` datetime default NULL,
  `is_die_drop_exp` int(11) default '0',
  PRIMARY KEY  (`rv_id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=1255 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=55991 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_auction_info` (
  ...
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=55582 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=5873 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=5978 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_auctionpet_info` (
  ...
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=5617 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=10223 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_avoidpkprop` (
  ...
  PRIMARY KEY  (`a_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=186 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_box_info` (
  ...
  `create_time` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33645 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_box_record` (
  ...
  `createtime` datetime default NULL,
  PRIMARY KEY  (`br_id`)
) ENGINE=InnoDB AUTO_INCREMENT=80506 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=8606 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=24736 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_goldbox_num_info` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3568 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_log_exp` (
  ...
  `createtime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2516 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_log_money` (
  ...
  `createtime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=450 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=85018 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2098 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2762514 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_mall_log` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`u_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=47087 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_part_info` (
  ...
  `p_title_name` varchar(50) default NULL,
  ...
  `p_wrap_spare` int(11) default NULL,
  `create_time` datetime default NULL,
  ...
  KEY `Index2` (`u_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=66009 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=85008 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_prelude` (
  ...
  PRIMARY KEY  (`pr_id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=62585 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_propgroup_info` (
  ...
  `prop_name` varchar(20) default NULL,
  `prop_price` int(11) default NULL,
  `prop_num` int(11) default NULL,
  `create_time` datetime default NULL,
  PRIMARY KEY  (`pg_pk`),
...
CREATE TABLE `u_quiz_info` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=1868 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_shortcut_info` (
  ...
  PRIMARY KEY  (`sc_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=593965 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=56491 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_sky_pay_record` (
  ...
  `p_pk` int(11) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22665 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=436 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_special_item` (
  ...
  PRIMARY KEY  (`sp_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=83429 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_special_prop` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=91114 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=564191 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=424880 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_time_control` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=166322 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong` */

DROP TABLE IF EXISTS `u_tong`;

CREATE TABLE `u_tong` (
  `t_pk` int(11) NOT NULL auto_increment,
  `t_name` varchar(20) default NULL,
  `t_grade` int(11) default NULL,
  `t_member_numb` int(11) default NULL,
  `t_nonce_numb` int(11) default NULL,
  `t_camp` varchar(50) default NULL,
  `t_league` varchar(500) default NULL,
  `t_foe` varchar(500) default NULL,
  `t_alter_time` int(11) default NULL,
  `create_time` datetime default NULL,
  PRIMARY KEY  (`t_pk`),
  KEY `Index1` (`t_pk`,`t_camp`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_affiche` */

DROP TABLE IF EXISTS `u_tong_affiche`;

CREATE TABLE `u_tong_affiche` (
  `ta_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `ta_title` varchar(1000) default NULL,
  `create_time` datetime default NULL,
  PRIMARY KEY  (`ta_pk`),
  KEY `Index1` (`t_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=207 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_attorn` */

DROP TABLE IF EXISTS `u_tong_attorn`;

CREATE TABLE `u_tong_attorn` (
  `ta_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `p_pk_big` int(11) default NULL,
  `create_time` datetime default NULL,
  `at_term` datetime default NULL,
  PRIMARY KEY  (`ta_pk`),
  KEY `Index1` (`t_pk`,`p_pk_big`,`create_time`,`at_term`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_battle` */

DROP TABLE IF EXISTS `u_tong_battle`;

CREATE TABLE `u_tong_battle` (
  `b_pk` int(11) NOT NULL auto_increment,
  `t_apply_pk` int(11) default NULL,
  `t_accept_pk` int(11) default NULL,
  `t_begin_time` datetime default NULL,
  `t_end_time` datetime default NULL,
  PRIMARY KEY  (`b_pk`),
  KEY `Index1` (`t_apply_pk`,`t_accept_pk`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_beg` */

DROP TABLE IF EXISTS `u_tong_beg`;

CREATE TABLE `u_tong_beg` (
  `tb_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `t_name` varchar(20) default NULL,
  `p_pk` int(11) default NULL,
  `p_name` varchar(20) default NULL,
  PRIMARY KEY  (`tb_pk`),
  KEY `Index1` (`t_pk`,`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=2877 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_build` */

DROP TABLE IF EXISTS `u_tong_build`;

CREATE TABLE `u_tong_build` (
  `utb_id` smallint(5) unsigned NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `tb_id` int(11) default NULL,
  `tb_name` varchar(50) default NULL,
  `tb_grade` int(11) default NULL,
  `tb_definition` varchar(200) default NULL,
  `tb_group` int(11) default NULL,
  `tb_map` int(11) default NULL,
  PRIMARY KEY  (`utb_id`),
  KEY `Index1` (`t_pk`,`tb_id`,`tb_group`,`tb_map`)
) ENGINE=InnoDB AUTO_INCREMENT=196 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_disband` */

DROP TABLE IF EXISTS `u_tong_disband`;

CREATE TABLE `u_tong_disband` (
  `td_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `create_time` datetime default NULL,
  `at_term` datetime default NULL,
  PRIMARY KEY  (`td_pk`),
  KEY `Index1` (`t_pk`,`create_time`,`at_term`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_glory` */

DROP TABLE IF EXISTS `u_tong_glory`;

CREATE TABLE `u_tong_glory` (
  `g_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `p_pk` int(11) default NULL,
  `p_name` varchar(20) default NULL,
  `kill_number` int(11) default '0',
  `intraday_value` int(11) default '0',
  `glory_value` int(11) default NULL,
  PRIMARY KEY  (`g_pk`),
  KEY `Index1` (`t_pk`,`p_pk`,`glory_value`)
) ENGINE=InnoDB AUTO_INCREMENT=66001 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_kill` */

DROP TABLE IF EXISTS `u_tong_kill`;

CREATE TABLE `u_tong_kill` (
  `k_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `p_pk` int(11) default NULL,
  `by_pPk` int(11) default NULL,
  `kill_number` int(11) default '0',
  PRIMARY KEY  (`k_pk`),
  KEY `Index1` (`t_pk`,`p_pk`,`by_pPk`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_member` */

DROP TABLE IF EXISTS `u_tong_member`;

CREATE TABLE `u_tong_member` (
  `tm_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `p_pk` int(11) default NULL,
  `p_name` varchar(20) default NULL,
  `tm_rights` int(11) default NULL,
  `tm_title` varchar(20) default NULL,
  `tm_proffer` int(11) default NULL,
  `battle_numb` int(11) default '0',
  `join_time` datetime default NULL,
  `tong_rights` varchar(50) default NULL,
  PRIMARY KEY  (`tm_pk`),
  KEY `Index1` (`t_pk`,`p_pk`,`tm_rights`)
) ENGINE=InnoDB AUTO_INCREMENT=2441 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_member_out` */

DROP TABLE IF EXISTS `u_tong_member_out`;

CREATE TABLE `u_tong_member_out` (
  `o_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `p_pk` int(11) default NULL,
  `out_time` datetime default NULL,
  PRIMARY KEY  (`o_pk`)
...
/*Table structure for table `u_tong_money` */

DROP TABLE IF EXISTS `u_tong_money`;

CREATE TABLE `u_tong_money` (
  `utm_id` smallint(5) unsigned NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `utm_money` varchar(20) default NULL,
  `utm_wrap_content` int(11) default '100',
  `utm_wrap_spare` int(11) default '100',
  PRIMARY KEY  (`utm_id`),
  KEY `Index1` (`t_pk`,`utm_wrap_spare`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_recruit` */

DROP TABLE IF EXISTS `u_tong_recruit`;

CREATE TABLE `u_tong_recruit` (
  `re_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `re_title` varchar(500) default NULL,
  `re_money` int(11) default NULL,
  `create_time` datetime default NULL,
  `re_term` datetime default NULL,
  PRIMARY KEY  (`re_pk`),
  KEY `Index1` (`t_pk`,`re_money`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_relation` */

DROP TABLE IF EXISTS `u_tong_relation`;

CREATE TABLE `u_tong_relation` (
  `r_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `r_tong_pk` int(11) default NULL,
  `r_name` varchar(20) default NULL,
  `r_relation` int(11) default NULL,
  PRIMARY KEY  (`r_pk`),
  KEY `Index1` (`t_pk`,`r_tong_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_res_log` */

DROP TABLE IF EXISTS `u_tong_res_log`;

CREATE TABLE `u_tong_res_log` (
  `l_pk` varchar(20) default NULL,
  `t_pk` int(11) default NULL,
  `l_content` varchar(300) default NULL,
  `create_time` datetime default NULL,
  KEY `Index1` (`t_pk`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_resource_equip` */

DROP TABLE IF EXISTS `u_tong_resource_equip`;

CREATE TABLE `u_tong_resource_equip` (
  `re_pk` smallint(5) unsigned NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `table_type` int(11) default NULL,
  `goods_type` int(11) default NULL,
  ...
  `w_Bonding_Num` int(11) default '0',
  PRIMARY KEY  (`re_pk`),
  KEY `Index1` (`t_pk`,`goods_type`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_resource_prop` */

DROP TABLE IF EXISTS `u_tong_resource_prop`;

CREATE TABLE `u_tong_resource_prop` (
  `rp_pk` int(11) NOT NULL auto_increment,
  `t_pk` int(11) default NULL,
  `pg_type` int(11) default NULL,
  `prop_id` int(11) default NULL,
  `prop_type` int(11) default NULL,
  ...
  `auction_type` int(11) default NULL,
  PRIMARY KEY  (`rp_pk`),
  KEY `Index1` (`t_pk`,`pg_type`,`prop_id`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

/*Table structure for table `u_tong_rights` */

DROP TABLE IF EXISTS `u_tong_rights`;

CREATE TABLE `u_tong_rights` (
  `tr_pk` int(11) NOT NULL auto_increment,
  `t_type` int(11) default NULL,
  `tr_name` varchar(20) default NULL,
  `tr_rights` varchar(100) default NULL,
  `url_join` varchar(100) default NULL,
  PRIMARY KEY  (`tr_pk`),
  KEY `Index1` (`t_type`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_warehouse_equip` (
  ...
  PRIMARY KEY  (`w_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=66991 DEFAULT CHARSET=gbk;
...
CREATE TABLE `user_online_time` (
  ...
  `createTime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=156251 DEFAULT CHARSET=gbk;
...
CREATE TABLE `user_record_login` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=62589 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=1955 DEFAULT CHARSET=gbk;
