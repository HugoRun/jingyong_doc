...
CREATE TABLE `game_statistics` (
  ...
  PRIMARY KEY  (`gs_id`)
) ENGINE=InnoDB AUTO_INCREMENT=173635 DEFAULT CHARSET=gbk;
...
CREATE TABLE `p_credit_relation` (
  ...
  `ppk` int(11) default NULL COMMENT '角色id',
  `cid` int(11) default NULL,
  `pcount` int(11) default '0',
  PRIMARY KEY  (`pcid`)
) ENGINE=MyISAM AUTO_INCREMENT=13298 DEFAULT CHARSET=gbk;
...
CREATE TABLE `p_pet_info` (
  ...
  `p_pk` int(11) default NULL COMMENT '角色id，负数时表示该宠物在仓库里',
...
) ENGINE=InnoDB AUTO_INCREMENT=66172 DEFAULT CHARSET=gbk;
...
CREATE TABLE `s_setting_info` (
  ...
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=66099 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=4083262 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_auction_info` (
  ...
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=55761 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=1089 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=447 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=24775 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=85117 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_mail_info` (
  ...
  `create_time` datetime default NULL,
  `attachment_str` varchar(100) default ' ' COMMENT '邮件附件字符串',
  PRIMARY KEY  (`mail_id`),
  KEY `Index1` (`receive_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=2762840 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_mounts_temp` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=484 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2225 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_part_info` (
  ...
  `player_state_by_new` int(11) default '1',
  ...
  KEY `Index2` (`u_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=66111 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=85108 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=852 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=2268287 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_shortcut_info` (
  ...
  PRIMARY KEY  (`sc_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=594835 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_special_item` (
  ...
  PRIMARY KEY  (`sp_pk`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=83483 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=564369 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_time_control` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=166438 DEFAULT CHARSET=gbk;
...
CREATE TABLE `u_title` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=69243 DEFAULT CHARSET=gbk;
...
CREATE TABLE `user_online_time` (
  ...
  `createTime` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=156434 DEFAULT CHARSET=gbk;
...
CREATE TABLE `user_record_login` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Index1` (`p_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=62690 DEFAULT CHARSET=gbk;
...
) ENGINE=InnoDB AUTO_INCREMENT=1972 DEFAULT CHARSET=gbk;
